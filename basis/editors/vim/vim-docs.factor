...
$nl
"You may also wish to install Vim support files to enable syntax hilighting and other features. These are in the " { $link site-resource-path } " in " { $snippet "misc/vim" } "."
{ $see-also "editor" }
;
