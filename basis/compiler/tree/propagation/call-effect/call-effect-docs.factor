USING: combinators+private compiler.tree.propagation.call-effect
compiler.units debugger effects help.markup help.syntax kernel
quotations words ;
IN: compiler.tree.propagation.call-effect+docs
