USING: classes compiler.tree.propagation.info
compiler.tree.propagation.known-words help.markup help.syntax
kernel math math.intervals ;
IN: compiler.tree.propagation.known-words+docs
