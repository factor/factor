...
{ $description "Allocates space for a stack parameter value of the given representation and natural byte size, and returns the previous stack parameter offset." }
{ $examples
