...
HOOK: %compare-branch cpu ( label src1 src2 cc -- )
HOOK: %compare-imm-branch cpu ( label src1 src2 cc -- )
HOOK: %compare-integer-imm-branch cpu ( label src1 src2 cc -- )
HOOK: %test-branch cpu ( label src1 src2 cc -- )
HOOK: %test-imm-branch cpu ( label src1 src2 cc -- )
HOOK: %compare-float-ordered-branch cpu ( label src1 src2 cc -- )
HOOK: %compare-float-unordered-branch cpu ( label src1 src2 cc -- )
