...
: grapheme-break-test ( -- filename )
    "https://downloads.factorcode.org/misc/UCD/17.0.0/auxiliary/GraphemeBreakTest.txt"
    "GraphemeBreakTest-17.0.0.txt" cache-file download-once-as ;

: word-break-test ( -- filename )
    "https://downloads.factorcode.org/misc/UCD/17.0.0/auxiliary/WordBreakTest.txt"
    "WordBreakTest-17.0.0.txt" cache-file download-once-as ;
