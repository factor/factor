...
: grapheme-break-test ( -- filename )
    "https://downloads.factorcode.org/misc/UCD/18.0.0/auxiliary/GraphemeBreakTest.txt"
    "GraphemeBreakTest-18.0.0.txt" cache-file download-once-as ;

: word-break-test ( -- filename )
    "https://downloads.factorcode.org/misc/UCD/18.0.0/auxiliary/WordBreakTest.txt"
    "WordBreakTest-18.0.0.txt" cache-file download-once-as ;
