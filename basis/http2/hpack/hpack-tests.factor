...
USING: tools.test http2.hpack hpack.private hpack accessors kernel ;
...
{ T{ decode-context f 64 { { "custom-key" "custom-header" } } } 
  BV{ 0x40 0x0a 0x63 0x75 0x73 0x74 0x6f 0x6d 0x2d 0x6b 0x65
  0x79 0x0d 0x63 0x75 0x73 0x74 0x6f 0x6d 0x2d 0x68 0x65 0x61
  0x64 0x65 0x72 } 26 { "custom-key" "custom-header" } }
[ decode-context new 64 >>max-size BV{ 0x40 0x0a 0x63 0x75 0x73
    0x74 0x6f 0x6d 0x2d 0x6b 0x65 0x79 0x0d 0x63 0x75 0x73 0x74
    0x6f 0x6d 0x2d 0x68 0x65 0x61 0x64 0x65 0x72 } 0 decode-field ] unit-test
