...
: uuid>string ( n -- string )
    >hex 32 ch'0 pad-head
    [ ch'- 20 ] dip insert-nth
    [ ch'- 16 ] dip insert-nth
    [ ch'- 12 ] dip insert-nth
    [ ch'- 8 ] dip insert-nth ;
...
: uuid3 ( namespace name -- string )
    ...
    md5 checksum-bytes 16 shorted head be>
...
: uuid5 ( namespace name -- string )
    [ uuid-parse ] dip append
    sha1 checksum-bytes 16 shorted head be>
