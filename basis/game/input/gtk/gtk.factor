...
MIXIN: gtk-game-input-backend
INSTANCE: gtk-game-input-backend linux-game-input-backend
...
M: gtk-game-input-backend (close-game-input) close-linux-controllers ;
M: gtk-game-input-backend (reset-game-input) reset-pointer-deltas ;
...
M: gtk-game-input-backend reset-mouse reset-pointer-deltas ;
