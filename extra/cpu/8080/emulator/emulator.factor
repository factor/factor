...
: cpu. ( cpu -- )
    {
        [ " PC: " write pc>> >hex 4 ch'\s pad-head write ]
        [ " B: " write b>> >hex 2 ch'\s pad-head write ]
        [ " C: " write c>> >hex 2 ch'\s pad-head write ]
        [ " D: " write d>> >hex 2 ch'\s pad-head write ]
        [ " E: " write e>> >hex 2 ch'\s pad-head write ]
        [ " F: " write f>> >hex 2 ch'\s pad-head write ]
        [ " H: " write h>> >hex 2 ch'\s pad-head write ]
        [ " L: " write l>> >hex 2 ch'\s pad-head write ]
        [ " A: " write a>> >hex 2 ch'\s pad-head write ]
        [ " SP: " write sp>> >hex 4 ch'\s pad-head write ]
        [ " cycles: " write cycles>> number>string 5 ch'\s pad-head write ]
