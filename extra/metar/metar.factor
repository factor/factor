...
: stations-data ( -- seq )
    ...
    http-get nip ch'\; [ string>csv ] with-delimiter ;
...
: parse-visibility ( str -- str' )
    ...
    ch'/ over index [ 1 > [ 1 cut "+" glue ] when ] when*
