...
{ $examples
    ...
    { $example "USING: kernel prettyprint sequences.extras ;" "\"   Hello,    crazy    world   \" [ ch'\\s = ] \" \" collapse ." "\" Hello, crazy world \"" } } ;
...
{ $examples
    "Collapse multiple spaces in a string down to a single space"
    { $example "USING: kernel prettyprint sequences.extras ;" "\"   Hello,    crazy    world   \" [ ch'\\s = ] \" \" compact ." "\"Hello, crazy world\"" } } ;
