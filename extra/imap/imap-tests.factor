...
continuations formatting fry grouping.extras imap io io.streams.duplex kernel
...
{ email host password } [ get ] all? [
    ...
    "All tests skipped because email account is not configured." write nl
] if
