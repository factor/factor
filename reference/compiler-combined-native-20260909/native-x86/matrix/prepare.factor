...
<< "compiler.cfg.loop-optimization" require
   ...
   refresh-all
   "reference/compiler-combined-20260909/features.factor" run-file
   "reference/compiler-combined-20260909/witnesses.factor" run-file >>
...
"reference/compiler-combined-20260909/prepared.image" save-image-and-exit
