...
:: installed-integer-path ( trial phase -- )
...
:: sample ( word trial -- )
    ...
    trial "after-batch" installed-integer-path
    background 0 = [
    H{ } clone
...
:: main ( -- )
    ...
    \ integer-pressure-work -1 sample
    checked [ ] [ command-line get third string>number [| trial | \ integer-pressure-work trial sample ] each-integer ] if ;
main
