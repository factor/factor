...
| Bundle obstruction | A merged multi-block bundle fits before a specific occupied point but conflicts afterward | Split is tied to the observed obstruction, not merely the median use; a noninitial obstruction leaves a conflict-free prefix, while an initial obstruction demonstrates mandatory minimal-piece progress |
