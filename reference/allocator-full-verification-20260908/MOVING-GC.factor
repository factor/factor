! Standalone native probe: no new allocation kernels or validation vocabulary.
! Load the exact four production repair files before this probe on a baseline.
USING: vocabs.loader ;
<< "compiler.cfg.liveness" reload
   "compiler.cfg.linear-scan.assignment" reload
   "compiler.cfg.linear-scan" reload
   "compiler.cfg.register-allocation.ssa.bases" reload
   "compiler.cfg.register-allocation.chordal.bases" reload
