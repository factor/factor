...
! Subprocess tests must use the same isolated image and source as this run.
"/Users/erg/factor/reference/arm64-varargs-20260908/verified-factor" \ vm-path set-global
