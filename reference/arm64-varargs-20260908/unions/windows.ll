...
define dso_local dllexport double @au_take_one([1 x float] %0, double noundef %1) #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_two([2 x float] %0, double noundef %1) #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_four([4 x float] %0, double noundef %1) #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_nested([2 x float] %0, double noundef %1) local_unnamed_addr #0 {
  %3 = extractvalue [2 x float] %0, 0
  %4 = extractvalue [2 x float] %0, 1
  %5 = tail call float @llvm.fmuladd.f32(float %4, float 2.000000e+00, float %3)
  %6 = fpext float %5 to double
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_mixed(i64 %0, double noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_padded([2 x i64] %0, double noundef %1) #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_padded_union([2 x i64] %0, double noundef %1) local_unnamed_addr #0 {
  %3 = extractvalue [2 x i64] %0, 0
  %4 = trunc i64 %3 to i32
  %5 = bitcast i32 %4 to float
  %6 = extractvalue [2 x i64] %0, 1
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport %union.au_one @au_return_one(float noundef %0) local_unnamed_addr #0 {
  %2 = insertvalue %union.au_one poison, float %0, 0
  ret %union.au_one %2
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport %union.au_two @au_return_two(float noundef %0, float noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport %union.au_four @au_return_four(float noundef %0, float noundef %1, float noundef %2, float noundef %3) local_unnamed_addr #0 {
...
define dso_local dllexport double @au_call_one(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_two(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
  %2 = tail call double %0([2 x float] [float 1.250000e+00, float 2.500000e+00], double noundef 1.000000e+01) #8
  ret double %2
}

; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_four(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
...
define dso_local dllexport double @au_variadic(i32 noundef %0, ...) #4 {
  ...
  %11 = fadd float %5, %10
  %12 = call float @llvm.fmuladd.f32(float %7, float 2.000000e+00, float %11)
...
; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_variadic(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
  %2 = tail call double (i32, ...) %0(i32 noundef 7, i64 4620693218749579264, double noundef 1.000000e+01) #8
  ret double %2
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_vector_two([2 x <4 x float>] %0, double noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport %union.au_vector_two @au_return_vector_two() local_unnamed_addr #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_vector_variadic(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
  %2 = alloca %union.au_vector_two, align 16
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #8
  store <4 x float> <float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.000000e+00>, ptr %2, align 16
  %3 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store <4 x float> <float 5.000000e+00, float 6.000000e+00, float 7.000000e+00, float 8.000000e+00>, ptr %3, align 16
  %4 = call double (i32, ...) %0(i32 noundef 7, ptr noundef nonnull align 16 dead_on_return %2, double noundef 1.000000e+01) #8
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #8
  ret double %4
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_vector([1 x <4 x float>] %0, double noundef %1) #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport %union.au_vector @au_return_vector(float noundef %0, float noundef %1, float noundef %2, float noundef %3) local_unnamed_addr #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_vector(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport [2 x i64] @au_return_padded(float noundef %0, float noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_padded(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
  %2 = tail call double %0([2 x i64] [i64 1067450368, i64 1075838976], double noundef 1.000000e+01) #8
  ret double %2
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_spill(double noundef %0, double noundef %1, double noundef %2, double noundef %3, double noundef %4, double noundef %5, [2 x float] %6, double noundef %7) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_spill(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
...
define dso_local dllexport noundef i32 @au_vector_available() local_unnamed_addr #6 {
  ret i32 1
}

; Function Attrs: nounwind uwtable
define dso_local dllexport range(i32 0, 2) i32 @au_c_controls() local_unnamed_addr #7 {
...
38:                                               ; preds = %35
  %39 = tail call double (i32, ...) @au_variadic(i32 noundef 7, i64 4620693218749579264, double noundef 1.000000e+01)
...
define internal double @au_vector_variadic_control(i32 noundef %0, ...) #4 {
  ...
  %12 = insertvalue [2 x <4 x float>] poison, <4 x float> %6, 0
  %13 = insertvalue [2 x <4 x float>] %12, <4 x float> %8, 1
...
; Function Attrs: nounwind uwtable
define dso_local dllexport range(i32 0, 2) i32 @au_small_controls() local_unnamed_addr #7 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport noundef i32 @au_small_available() local_unnamed_addr #6 {
  ret i32 1
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_small([1 x half] %0, double noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_bsmall([1 x bfloat] %0, double noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport %union.au_small @au_return_small(float noundef %0) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport %union.au_bsmall @au_return_bsmall(float noundef %0) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local dllexport double @au_take_small_pair([2 x half] %0, double noundef %1) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_small_pair(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
  %2 = tail call double %0([2 x half] [half 1.250000e+00, half 2.062500e+00], double noundef 1.000000e+01) #8
  ret double %2
}

; Function Attrs: noinline nounwind uwtable
define dso_local dllexport double @au_call_small_variadic(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #2 {
  %2 = tail call double (i32, ...) %0(i32 noundef 7, i64 1075854592, double noundef 1.000000e+01) #8
  ret double %2
}
...
define internal double @au_small_variadic_control(i32 noundef %0, ...) #4 {
  ...
  %11 = insertvalue [2 x half] poison, half %5, 0
  %12 = insertvalue [2 x half] %11, half %7, 1
  %13 = call double @au_take_small_pair([2 x half] %12, double noundef %9)
  %14 = fadd double %13, %10
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #8
  ret double %14
}

attributes #0 = { mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable "frame-pointer"="reserved" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+v8a,-fmv" }
attributes #1 = { mustprogress nocallback nocreateundeforpoison nofree nosync nounwind speculatable willreturn memory(none) }
attributes #2 = { noinline nounwind uwtable "frame-pointer"="reserved" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+v8a,-fmv" }
attributes #3 = { mustprogress nocallback nofree nosync nounwind willreturn memory(argmem: readwrite) }
attributes #4 = { mustprogress nofree noinline norecurse nosync nounwind willreturn uwtable "frame-pointer"="reserved" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+v8a,-fmv" }
attributes #5 = { mustprogress nocallback nofree nosync nounwind willreturn }
attributes #6 = { mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable "frame-pointer"="reserved" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+v8a,-fmv" }
attributes #7 = { nounwind uwtable "frame-pointer"="reserved" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+v8a,-fmv" }
...
!0 = distinct !DICompileUnit(language: DW_LANG_C11, file: !1, producer: "Homebrew clang version 23.1.0", isOptimized: true, runtimeVersion: 0, emissionKind: NoDebug, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "vm/ffi_test_arm64_unions.c", directory: "/Users/erg/factor.worktrees/arm64-varargs-bindings")
!2 = !{i32 2, !"Debug Info Version", i32 3}
!3 = !{i32 8, !"PIC Level", i32 2}
!4 = !{i32 7, !"uwtable", i32 2}
!5 = !{i32 7, !"frame-pointer", i32 3}
!6 = !{!"Homebrew clang version 23.1.0"}
