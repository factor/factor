...
/home/erg/factor-compiler-next-final-c6948-20260909/reference/compiler-next-20260909/captured-addition-candidate.bin:     file format binary
...
0000000000000000 <.data>:
      ...
      7f:	49 8d 55 10          	lea    0x10(%r13),%rdx
      83:	48 8b 0a             	mov    (%rdx),%rcx
      86:	48 83 c1 10          	add    $0x10,%rcx
      8a:	48 3b 4a 10          	cmp    0x10(%rdx),%rcx
     ...
     183:	49 8b 07             	mov    (%r15),%rax
     186:	49 8b 5f f8          	mov    -0x8(%r15),%rbx
     18a:	49 83 c6 10          	add    $0x10,%r14
     18e:	49 83 ef 10          	sub    $0x10,%r15
     192:	49 89 46 f8          	mov    %rax,-0x8(%r14)
     196:	49 89 1e             	mov    %rbx,(%r14)
     ...
     43d:	49 8d 45 10          	lea    0x10(%r13),%rax
     441:	48 8b 18             	mov    (%rax),%rbx
     444:	48 83 c3 10          	add    $0x10,%rbx
     448:	48 3b 58 10          	cmp    0x10(%rax),%rbx
     ...
     690:	49 8d 5d 10          	lea    0x10(%r13),%rbx
     694:	48 8b 03             	mov    (%rbx),%rax
     697:	48 83 c0 10          	add    $0x10,%rax
     69b:	48 3b 43 10          	cmp    0x10(%rbx),%rax
     ...
     77b:	49 8d 45 10          	lea    0x10(%r13),%rax
     77f:	48 8b 18             	mov    (%rax),%rbx
     782:	48 83 c3 10          	add    $0x10,%rbx
     786:	48 3b 58 10          	cmp    0x10(%rax),%rbx
     ...
     914:	49 8d 4d 10          	lea    0x10(%r13),%rcx
     918:	48 8b 11             	mov    (%rcx),%rdx
     91b:	48 83 c2 20          	add    $0x20,%rdx
     91f:	48 3b 51 10          	cmp    0x10(%rcx),%rdx
     ...
     cb2:	49 8d 4d 10          	lea    0x10(%r13),%rcx
     cb6:	48 8b 11             	mov    (%rcx),%rdx
     cb9:	48 83 c2 20          	add    $0x20,%rdx
     cbd:	48 3b 51 10          	cmp    0x10(%rcx),%rdx
     ...
     e10:	49 8d 4d 10          	lea    0x10(%r13),%rcx
     e14:	48 8b 11             	mov    (%rcx),%rdx
     e17:	48 83 c2 20          	add    $0x20,%rdx
     e1b:	48 3b 51 10          	cmp    0x10(%rcx),%rdx
     ...
     ed3:	49 8b 1f             	mov    (%r15),%rbx
     ed6:	49 8b 47 f8          	mov    -0x8(%r15),%rax
     eda:	49 83 c6 10          	add    $0x10,%r14
     ede:	49 83 ef 10          	sub    $0x10,%r15
     ee2:	49 89 5e f8          	mov    %rbx,-0x8(%r14)
     ee6:	49 89 06             	mov    %rax,(%r14)
    ...
    1101:	49 8d 55 10          	lea    0x10(%r13),%rdx
    1105:	48 8b 0a             	mov    (%rdx),%rcx
    1108:	48 83 c1 20          	add    $0x20,%rcx
    110c:	48 3b 4a 10          	cmp    0x10(%rdx),%rcx
    ...
    12e1:	49 8b 1f             	mov    (%r15),%rbx
    12e4:	49 8b 47 f8          	mov    -0x8(%r15),%rax
    12e8:	49 83 c6 10          	add    $0x10,%r14
    12ec:	49 83 ef 10          	sub    $0x10,%r15
    12f0:	49 89 5e f8          	mov    %rbx,-0x8(%r14)
    12f4:	49 89 06             	mov    %rax,(%r14)
    ...
    13a6:	49 8d 4d 10          	lea    0x10(%r13),%rcx
    13aa:	48 8b 11             	mov    (%rcx),%rdx
    13ad:	48 83 c2 20          	add    $0x20,%rdx
    13b1:	48 3b 51 10          	cmp    0x10(%rcx),%rdx
