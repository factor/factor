...
: drop-prefix ( seq1 seq2 -- slice1 slice2 )
    [ mismatch ] 2check [ 2dup min-length ] unless*
    [ tail-slice ] curry bi@ ;
...
: select-by ( ... seq quot: ( ... elt -- ... x ) compare: ( obj1 obj2 -- ? ) -- ... elt )
    [
        [ 1check ] curry [ [ first ] dip call ] 2keep
