USING: arrays generic inference inference.backend inference.dataflow kernel
kernel.private math math.parser math.private namespaces namespaces.private parser sequences strings
vectors words quotations effects tools.test continuations
generic.standard sorting assocs ;
IN: temporary
...
[ 3 [ ] curry 1 2 [ ] 2curry if ] unit-test-fails
