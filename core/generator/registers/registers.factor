...
namespaces sequences assocs system combinators classes
cpu.architecture words inference.dataflow hashtables vectors
quotations generator.fixup ;
...
: template-classes-match? ( -- ? )
    ...
    [ dup length 3 = [ third class< ] [ 2drop t ] if ] 2map
    [ ] all? ;
