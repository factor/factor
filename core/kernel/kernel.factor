...
: 1if ( ..a x pred: ( ..a x -- ..b x ? ) true: ( ..b x -- ..c ) false: ( ..b x -- ..c ) -- ..c )
...
!   vm/objects.hpp
CONSTANT: special-object-count 83
...
CONSTANT: MEGA-LOOKUP 60
CONSTANT: MEGA-LOOKUP-WORD 61
CONSTANT: MEGA-MISS-WORD 62

CONSTANT: OBJ-UNDEFINED 63

CONSTANT: OBJ-STDERR 64

CONSTANT: OBJ-STAGE2 65

CONSTANT: OBJ-CURRENT-THREAD 66

CONSTANT: OBJ-THREADS 67
CONSTANT: OBJ-RUN-QUEUE 68
CONSTANT: OBJ-SLEEP-QUEUE 69

CONSTANT: OBJ-VM-COMPILER 70

CONSTANT: OBJ-WAITING-CALLBACKS 71

CONSTANT: OBJ-SIGNAL-PIPE 72

CONSTANT: OBJ-VM-COMPILE-TIME 73

CONSTANT: OBJ-VM-VERSION 74
CONSTANT: OBJ-VM-GIT-LABEL 75

CONSTANT: OBJ-CANONICAL-TRUE 76

CONSTANT: OBJ-BIGNUM-ZERO 77
CONSTANT: OBJ-BIGNUM-POS-ONE 78
CONSTANT: OBJ-BIGNUM-NEG-ONE 79

CONSTANT: PIC-MISS-RESUME-WORD 80
CONSTANT: PIC-MISS-JUMP 81
CONSTANT: PIC-MISS-TAIL-JUMP 82
