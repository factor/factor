...
USING: assocs bootstrap.image.private hash-sets hashtables
hashtables.identity hashtables.wrapped init io io.files kernel
kernel.private make memory namespaces parser parser.notes
sequences system vocabs vocabs.hierarchy vocabs.loader ;
