...
: callback-22
    "longlong" { "long" "long" } "cdecl" [ * ] alien-callback ;

: callback_test_15
    "longlong" { "long" "long" } "cdecl" alien-indirect ;

[ 121932631112635269 ]
[ 123456789 987654321 callback-22 callback_test_15 ] unit-test

: callback-23
    "long" { "longlong" "longlong" } "cdecl"
    [ 2dup . . /i ] alien-callback ;

: callback_test_16
    "long" { "longlong" "longlong" } "cdecl" alien-indirect ;

[ 987654321 ]
[ 121932631112635269 123456789 callback-23 callback_test_16 ]
unit-test
