...
{ $errors "Throws an error if a positive shift count is too large to fit in a fixnum. Negative counts beyond the fixnum range produce zero or minus one, according to the sign of the input." }
