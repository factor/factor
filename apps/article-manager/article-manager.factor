...
!
USING: kernel html furnace sqlite io file-responder namespaces httpd html xml-writer sequences math article-manager-db tuple-db generic arrays basic-authentication hashtables assocs quotations ;
IN: furnace:article-manager 
...
! 'site-index' action.
! "article-manager" "site-index" "apps/article-manager/furnace/" web-app
...
! [
!   "apps/article-manager/resources/" resource-path "doc-root" set
!   file-responder
! ] with-scope
