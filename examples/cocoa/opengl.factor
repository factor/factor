IN: cocoa-opengl
USING: alien cocoa compiler inspector io kernel math namespaces
objc objc-NSObject objc-NSOpenGLContext objc-NSOpenGLView
...
dup <FactorView> [setContentView:] f [makeKeyAndOrderFront:]
