USING: accessors kernel pg.tetromino pg.piece tools.test sequences arrays namespaces ;

! Tests for pg.tetromino and pg.piece, since there's not much to test in pg.tetromino
