USING: kernel parser strings math namespaces sequences words errors io arrays 
kernel-internals quotations ;
IN: state-machine
...
TUPLE: missing-state ;
: missing-state <missing-state> throw ;
