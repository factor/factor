...
// fields but the owner and parameters are set to false_object. Parameters is
// false_object for ordinary stubs or the immediate fixnum 1 for ARM64 variadic
// stubs; it never holds a heap pointer. The owner points to the callback
