...
Like \texttt{with-html-stream}, except some tags such as \texttt{<html>}, \texttt{<head>} and \texttt{<body>} are output. The title is output in two places; a \texttt{<title>} tag  and \texttt{<h1>} tag.
